...
class LocalModel(object):
    def __init__(self, model_config, data_collected):
        ...
        print("LocalModel__init__")

    def get_weights(self):
        print("LocalModel get_weights")
        return self.model.get_weights()
    

    def set_weights(self, new_weights):
        print("LocalModel set_weights")
    ...
    def train_one_round(self):
        ...
        print("LocalModel train_one_round")
...
class FederatedClient(object):
    ...
    def register_handles(self):
        ...
        def on_request_update(*args):
          ...
          #print("obj_to_pickle_string(my_weights)",obj_to_pickle_string(my_weights))
            ...
            print("FederatedClient register_handles")
        ...
        print("FederatedClient on_stop_and_evals")
    ...
    def intermittently_sleep(self, p=.1, low=10, high=100):
        ...
        print("FederatedClient intermittently_sleep")
...
if __name__ == "__main__":
    ...
    FederatedClient("172.31.0.139", 55555, datasource.Mnist)
