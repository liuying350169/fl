...
class Mnist(DataSource):
    ...
    def __init__(self):
        ...
        x0 = x_train[y_train == 0][BASE_SELECT:NUM_CLASS_BIG+BASE_SELECT]
        y0 = y_train[y_train == 0][BASE_SELECT:NUM_CLASS_BIG+BASE_SELECT]
        x1 = x_train[y_train == 1][BASE_SELECT:NUM_CLASS_BIG+BASE_SELECT]
        y1 = y_train[y_train == 1][BASE_SELECT:NUM_CLASS_BIG+BASE_SELECT]
