...
def start_client1():
    print("start client1")
    c = FederatedClient("172.31.2.6",1111, datasource1.Mnist)
def start_client2():
    print("start client2")
    c = FederatedClient("172.31.2.6",1111, datasource2.Mnist)
def start_client3():
    print("start client3")
    c = FederatedClient("172.31.2.6",1111, datasource3.Mnist)
def start_client4():
    print("start client4")
    c = FederatedClient("172.31.2.6",1111, datasource4.Mnist)
def start_client5():
    print("start client5")
    c = FederatedClient("172.31.2.6",1111, datasource5.Mnist)
def start_client6():
    print("start client6")
    c = FederatedClient("172.31.2.6",1111, datasource1.Mnist)
def start_client7():
