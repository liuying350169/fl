...
def start_client1():
    print("start client1")
    c = FederatedClient("172.31.0.139",55555, datasource1.Mnist)
def start_client2():
    print("start client2")
    c = FederatedClient("172.31.0.139",55555, datasource2.Mnist)
def start_client3():
    print("start client3")
    c = FederatedClient("172.31.0.139",55555, datasource3.Mnist)
def start_client4():
    print("start client4")
    c = FederatedClient("172.31.0.139",55555, datasource4.Mnist)
def start_client5():
    print("start client5")
    c = FederatedClient("172.31.0.139",55555, datasource5.Mnist)
def start_client6():
    print("start client6")
    c = FederatedClient("172.31.0.139",55555, datasource1.Mnist)
def start_client7():
    print("start client7")
    c = FederatedClient("172.31.0.1392",55555, datasource2.Mnist)
def start_client8():
    print("start client8")
    c = FederatedClient("172.31.0.139",55555, datasource3.Mnist)
def start_client9():
