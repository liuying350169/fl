...
class Mnist(DataSource):
    ...
    def __init__(self):
        ...
        x0 = x_train[y_train == 0][0:NUM_CLASS]
        y0 = y_train[y_train == 0][0:NUM_CLASS]
        x1 = x_train[y_train == 1][0:NUM_CLASS]
        y1 = y_train[y_train == 1][0:NUM_CLASS]
        x2 = x_train[y_train == 2][0:NUM_CLASS]
        y2 = y_train[y_train == 2][0:NUM_CLASS] 
        x3 = x_train[y_train == 3][0:NUM_CLASS]
        y3 = y_train[y_train == 3][0:NUM_CLASS]
        x4 = x_train[y_train == 4][0:NUM_CLASS]
        y4 = y_train[y_train == 4][0:NUM_CLASS]
        x5 = x_train[y_train == 5][0:NUM_CLASS]
        y5 = y_train[y_train == 5][0:NUM_CLASS]
        x6 = x_train[y_train == 6][0:NUM_CLASS]
        y6 = y_train[y_train == 6][0:NUM_CLASS]
        x7 = x_train[y_train == 7][0:NUM_CLASS]
        y7 = y_train[y_train == 7][0:NUM_CLASS]
        x8 = x_train[y_train == 8][0:NUM_CLASS]
        y8 = y_train[y_train == 8][0:NUM_CLASS]
        x9 = x_train[y_train == 9][0:NUM_CLASS]
        y9 = y_train[y_train == 9][0:NUM_CLASS]
...
#         self.y = np.concatenate([y_train,y_test])        
    ...
    def sample_single_non_iid(self, x, y, weight=None):
        ...
        chosen_class = np.random.choice(self.classes)
